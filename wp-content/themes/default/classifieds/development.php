...
<?php $results = $wp_query->data['development']; $headings = $results[0]->development_name; ?> 
<?php $num = Property::getCountbyDevelopment($results[0]->development_slug); global $gRating; ?>
<div id="content">
